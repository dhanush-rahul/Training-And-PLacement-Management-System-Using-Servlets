...
<body>
	<div class="container">
		<form class="center" action="StudentServlet?operation=Complaint"
			method=post>
			<div class="row">
				<div class="col-25">
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" name="stream" value=<%=student.getStream()%>
						readonly>
				</div>
			</div>
			<div class="row">
				<div class="col-25">
					<label> Complaint/Issue(in 50 letters):</label>
				</div>
				<div class="col-75">
